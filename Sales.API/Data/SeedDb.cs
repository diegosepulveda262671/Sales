    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
           ...
           // await CheckCountriesAsync();
            ...
            await CheckUserAsync("1000", "Diego", "Sepúlveda", "diego@yopmail.com", "322 00 00 00", "Calle Luna Calle Sol", "diego.jpeg", UserType.Admin);
            await CheckUserAsync("2000", "Ledys", "Bedoya", "ledys@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "LedysBedoya.jpeg", UserType.User);
            await CheckUserAsync("3000", "Brad", "Pitt", "brad@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Brad.jpg", UserType.User);
            await CheckUserAsync("4000", "Angelina", "Jolie", "angelina@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Angelina.jpg", UserType.User);
            await CheckUserAsync("5000", "Bob", "Marley", "bob@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "bob.jpg", UserType.User);
